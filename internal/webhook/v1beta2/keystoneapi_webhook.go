...
// Package v1beta2 contains webhook implementations for KeystoneAPI v1beta2 resources.
package v1beta2
...
func SetupKeystoneAPIWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr).For(&keystonev1beta2.KeystoneAPI{}).
		WithValidator(&KeystoneAPICustomValidator{}).
		WithDefaulter(&KeystoneAPICustomDefaulter{}).
		Complete()
}

// +kubebuilder:webhook:path=/mutate-keystone-openstack-org-v1beta2-keystoneapi,mutating=true,failurePolicy=fail,sideEffects=None,groups=keystone.openstack.org,resources=keystoneapis,verbs=create;update,versions=v1beta2,name=mkeystoneapi-v1beta2.kb.io,admissionReviewVersions=v1
...
func (d *KeystoneAPICustomDefaulter) Default(_ context.Context, obj runtime.Object) error {
	keystoneapi, ok := obj.(*keystonev1beta2.KeystoneAPI)
	...
	// Call the defaulting logic from api/v1beta2
	keystoneapi.Default()

	return nil
}

// +kubebuilder:webhook:path=/validate-keystone-openstack-org-v1beta2-keystoneapi,mutating=false,failurePolicy=fail,sideEffects=None,groups=keystone.openstack.org,resources=keystoneapis,verbs=create;update,versions=v1beta2,name=vkeystoneapi-v1beta2.kb.io,admissionReviewVersions=v1
...
func (v *KeystoneAPICustomValidator) ValidateCreate(_ context.Context, obj runtime.Object) (admission.Warnings, error) {
	...
	// Call the validation logic from api/v1beta2
...
func (v *KeystoneAPICustomValidator) ValidateUpdate(_ context.Context, oldObj, newObj runtime.Object) (admission.Warnings, error) {
	keystoneapi, ok := newObj.(*keystonev1beta2.KeystoneAPI)
	if !ok {
