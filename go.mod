...
require (
	...
	github.com/openshift/api v3.9.0+incompatible // latest commit from release-4.13 tag
...
replace github.com/openstack-k8s-operators/lib-common/modules/common => github.com/stuggi/lib-common/modules/common v0.0.0-20230713140831-d34a206a730c
