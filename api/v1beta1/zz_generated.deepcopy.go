...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KeystoneAPIOverrideSpec) DeepCopyInto(out *KeystoneAPIOverrideSpec) {
	*out = *in
	if in.Route != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KeystoneAPIOverrideSpec.
func (in *KeystoneAPIOverrideSpec) DeepCopy() *KeystoneAPIOverrideSpec {
	if in == nil {
		return nil
	}
	out := new(KeystoneAPIOverrideSpec)
	in.DeepCopyInto(out)
	return out
}
